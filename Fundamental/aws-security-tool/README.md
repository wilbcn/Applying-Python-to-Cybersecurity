...
I thoroughly enjoyed creating this project and programme, and it was a great introduction to boto3 and the possibilities of using Python to automate security checks in the cloud. To expand on this, I would like to create a follow up, looking at automating fixing some of these security checks. For example, automating access key rotation, enabling MFA for users, and changing old or weak passwords. I will keep exploring the boto3 documentation and programming in Python, looking at ways to bolster my knowledge surrounding these topics. 
